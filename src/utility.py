...
class Transition(object):
    ...
    def __init__(self, s0_augmented, a0, r: float, is_done: bool, s1_augmented, action_info_0, total_0, total_1, useful_patterns, val_list):
        self.data = (s0_augmented, a0, r, is_done, s1_augmented,
                     action_info_0, total_0, total_1, useful_patterns, val_list)
    ...
    def __str__(self):
        ...
        result = 'transit from bipartite graph with edge' + \
            str(edge_num1) + ' to ' + str(edge_num2) + \
            ' collecting the reward ' + str(self.data[2])
        return result
...
def show_final_solution(cut):
    ...
    print('Total number of rolls used: ', int(
        np.asarray(cut.ColumnSol_Val).sum()))
##############
